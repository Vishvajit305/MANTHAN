...
def on_click():
    ...
    if not os.path.exists(newpath):
        ...
        messagebox.showwarning("Warning","The name is already exist!\nGive a unique name")
    

root=Tk()
e0=Entry(root,width=25)
e0.pack(pady=15)
e0.insert(0,"Enter the name of the terriorist")

e1=Entry(root,width=25)
e1.pack(pady=15)
e1.insert(0,"Enter the filepath")
